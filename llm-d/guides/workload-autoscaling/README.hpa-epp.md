...
- **Metric Collection:** For details on how to ensure scraping is active, see the [llm-d Monitoring Guide](../../docs/monitoring/README.md#epp-endpoint-picker-metrics).
